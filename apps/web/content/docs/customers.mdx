---
title: Customers
description: Sync your app's billing identity into PayKit and keep Stripe mappings internal.
---

A customer is your app's user or billing entity. It can be a user ID, an org ID, or any string that uniquely identifies who's paying. PayKit maps it to the Stripe customer ID internally, so your app never has to think about Stripe IDs.
...
`deleteCustomer` removes the customer from PayKit and cancels any active subscriptions in Stripe.
