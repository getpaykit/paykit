...
Runs PayKit's local webhook listener. It registers a Stripe webhook tunnel, replays missed events, and streams new webhooks while you develop.
...
- Sync status between your config, database, and Stripe
