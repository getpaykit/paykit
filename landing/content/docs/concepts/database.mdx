...
When you remove a plan from your config, `push` archives the product instead of deleting it. Archived products stay in the database for historical subscriptions and provider webhooks, and Stripe products are marked inactive.
