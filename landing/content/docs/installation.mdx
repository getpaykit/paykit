...
<Tabs items={["pnpm", "npm", "yarn", "bun"]}>
  <Tab value="pnpm">```bash pnpm add @paykit/core @paykit/stripe @paykit/prisma ```</Tab>
  <Tab value="npm">```bash npm install @paykit/core @paykit/stripe @paykit/prisma ```</Tab>
  <Tab value="yarn">```bash yarn add @paykit/core @paykit/stripe @paykit/prisma ```</Tab>
  <Tab value="bun">```bash bun add @paykit/core @paykit/stripe @paykit/prisma ```</Tab>
</Tabs>
